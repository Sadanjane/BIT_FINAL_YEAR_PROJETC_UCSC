...
import com.OMEL.repository.QuatationHasItemRepository;
...
@RestController
@RequestMapping(value = "/quatation_has_item")
public class QuatationHasItemController {
    ...
    @Autowired
    private QuatationHasItemRepository dao;


    @GetMapping(value = "/list", produces = "application/json")
    public List<QuatationHasItem> quatationList(){
        return dao.findAll();
    }
...
*/
    ...
    @GetMapping(value = "/listByQhi" , params = {"quatationid" , "itemid"} , produces = "application/json")
    public QuatationHasItem quatationHasItemList (@RequestParam("quatationid") int quatationid , @RequestParam("itemid")int itemid){
        return dao.listByQuatationItem(quatationid , itemid);
    }

   /* //get mapping for get quataionhasItem obejct list by given quatationid and itemid
    @GetMapping(value = "/listByQ" , params = {"quatationid"} , produces = "application/json")
    public List<QuatationHasItem> quatationHasItems (@RequestParam("quatationid") int quatationid){

...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    @Query(value="SELECT new User (u.id,u.userName , u.active) FROM User u ")
    List<User> list();

    @Query(value="SELECT new User(u.id,u.userName , u.active) FROM User u where u.userName='admin'")
    User getAdmin();
